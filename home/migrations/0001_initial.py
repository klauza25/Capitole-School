# Generated by Django 5.1.6 on 2025-07-22 12:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effectif_max', models.PositiveIntegerField(verbose_name='Effectif maximum')),
            ],
            options={
                'verbose_name': 'Classe',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Super Administrateur'), ('directeur', 'Directeur'), ('secretaire', 'Secrétariat'), ('enseignant', 'Enseignant'), ('surveillant', 'Surveillant'), ('eleve', 'Élève'), ('parent', 'Parent')], db_index=True, max_length=20, verbose_name='Rôle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classe_actuelle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.classe', verbose_name='Classe actuelle')),
                ('utilisateur', models.OneToOneField(limit_choices_to={'role': 'eleve'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Utilisateur')),
            ],
            options={
                'verbose_name': 'Élève',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('niveau', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.niveau', verbose_name='Niveau')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trimestre', models.CharField(choices=[('T1', 'Trimestre 1'), ('T2', 'Trimestre 2'), ('T3', 'Trimestre 3')], max_length=10, verbose_name='Trimestre')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['eleve', 'trimestre'], name='home_note_eleve_i_1b2ec1_idx')],
